...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<title>出错了!</title>
    <link rel="stylesheet" href="css/a8ui.common.css" media="all">
...
<div class="error_404">
	<div class="container clearfix">
        ...
        <div class="error_info">
        	<h2><p>对不起，您访问的页面不存在！</p></h2>
            <div class="operate">
            	<input class="global_btn btn_89bf43" onclick="location.href='index0.jsp'" type="button" value="返回主页">
